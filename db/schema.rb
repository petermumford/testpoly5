...
ActiveRecord::Schema.define(version: 20160229105234) do
  ...
  add_index "categorisations", ["categorisable_type", "categorisable_id"], name: "index_categorisations_on_able_type_and_able_id", using: :btree
